...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata__Internal_QRadioButton_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata__Internal_QRadioButton_t qt_meta_stringdata__Internal_QRadioButton = {
    {
...
Q_CONSTINIT static const uint qt_meta_data__Internal_QRadioButton[] = {
...
Q_CONSTINIT const QMetaObject _Internal_QRadioButton::staticMetaObject = { {
    ...
    qt_meta_stringdata__Internal_QRadioButton.offsetsAndSizes,
...
void _Internal_QRadioButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &_Internal_QRadioButton::doubleClicked; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
